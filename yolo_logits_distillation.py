...
# val_lines = np.load('val_logits.npy')[()]
    ...
    if True:
        ...
        model.save_weights(log_dir + 'distillation_mobilenet_trained_weights_stage_1.h5')
    ...
    if True:
        ...
        model.save_weights(log_dir + 'distillation_mobilenet_trained_weights_final.h5')
