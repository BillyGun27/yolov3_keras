  ...
  #      val_lines = f.readlines()
   ...
   #     test_lines = f.readlines()
    ...
    if True:
        ...
        model.save_weights(log_dir + 'trained_distillation_weights_stage_1_mobilenet_v2.h5')
    ...
    if True:
        ...
        model.save_weights(log_dir + 'trained_distillation_weights_final_mobilenet_v2.h5')
