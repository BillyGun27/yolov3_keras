...
from model.squeezenet import squeezenet_yolo_body
...
def _main():
   ...
   # test_path = '2007_test.txt'
    ...
    model = create_model(input_shape, anchors, num_classes,load_pretrained=False,
        freeze_body=2, weights_path='model_data/trained_weights_final_squeezenet.h5') # make sure you know what you freeze
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    model_body = squeezenet_yolo_body(image_input, num_anchors//3, num_classes)
