...
from model.small_mobilenet import mobilenet_yolo_body
   ...
   # test_path = '2007_test.txt'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes, 
            freeze_body=2, weights_path='model_data/trained_weights_final_mobilenet.h5') # make sure you know what you freeze
